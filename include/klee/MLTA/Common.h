...
std::string getFileName(DILocation *Loc, 
...
std::string extractMacro(std::string, Instruction* I);

DILocation *getSourceLocation(Instruction *I);

void printSourceCodeInfo(Value *V, std::string Tag = "VALUE");
void printSourceCodeInfo(Function *F, std::string Tag = "FUNC");
